...
- [ ] Move the project to the new level in Devstats
- [ ] Move artwork in [cncf/artwork](https://github.com/cncf/artwork) 
- [ ] Move project in maintainer spreadsheet
- [ ] Sent email to CNCF PR team for marketing the change
- [ ] Run CNCF Calendar update automation
